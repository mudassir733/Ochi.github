...
function Footer() {
  return (
    <div
      ...
      data-scroll-option
      data-scroll-speed=".3"
      className="w-full h-fit bg-zinc-900 rounded-tl-3xl rounded-tr-3xl"
    >
      <div className="grid grid-cols-2 px-12 pt-16">
        <article className="font-['Test_Founders_Grotesk_X-Cond_SmBd'] uppercase leading-[7vw]">
          <h1 className="text-[8rem]">eye-</h1>
          <h1 className="text-[8rem]">opening</h1>
        </article>
        <article>
          <h1 className="text-[8rem] leading-[7vw] font-['Test_Founders_Grotesk_X-Cond_SmBd'] uppercase">
            presentations
          </h1>
          {/* Social */}
          <div className="flex flex-col gap-2 pt-12 font-['Neue_Montreal']">
            <h3 className="pb-6">S:</h3>
            {["instagram", "behance", "facebook", "linkedin"].map(
              (item, index) => (
                <a className="font-sm cursor-pointer border-b-[1px] border-[#ffffff21] pb-1">
                  {item}
                </a>
              )
            )}
          ...
          {/* Social Ends */}
          {/* location */}
          <div className="grid grid-cols-2 gap-[20vw] mt-[3rem]">
            {/* First col */}
            <div className="flex flex-col">
              <h3 className="pb-6">L:</h3>
              {[
                "202-1965 W 4th Ave",
                "Vancouver, Canada",
                "30 Chukarina St",
                ...
                <a
                  className={`font-sm border-b-[1px] border-[#ffffff21] pb-1 ${
                    index === 2 && "pt-8"
                  }`}
                >
                  {item}
            ...
            <div className="flex flex-col">
              ...
              {[
                ...
                <a className="font-sm border-b-[1px] border-[#ffffff21] pb-1">
                  {item}
                </a>
              ))}
            </div>
      ...
      {/* Bottom Footer */}
      <div className="px-12 mt-12 py-5 flex items-center justify-between">
        ...
        <div>
          <p className="font-sm font-['Neue_Montreal'] uppercase text-[13px]">
        ...
        <div>
          <p className="uppercase text-[13px]">
            Website by{" "}
            <a
              href="https://www.linkedin.com/in/mudassir-ali-18b6522a6/"
              className="text-[#CDEA68] border-b-[1px] border-[#ceea6838] font-['Neue_Montreal']"
            >
              Mudassir Ali
            </a>
          </p>
